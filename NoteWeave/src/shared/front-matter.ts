...
/** 解析顶部 YAML front matter，未命中返回 frontMatter=null 且 body=原文。 */
...
/** 将 FrontMatter 序列化回 YAML 字符串（不含围栏）。 */
...
/** 由 FrontMatter 与正文构造完整的 Markdown（含 --- 围栏）。 */
