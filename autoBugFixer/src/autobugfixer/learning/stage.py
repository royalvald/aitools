...
from autobugfixer.core.models import FixRecord, InapplicableCase, VerifyRecord
from autobugfixer.prompts import load_prompt
from autobugfixer.knowledge.experience import ExperienceService
from autobugfixer.learning.schemas import FailureAnalysis
from autobugfixer.core.stage import InterventionRequest, StageResult, TaskContext
...
class LearningStage:
    ...
    def _distill_skills(self, ctx: TaskContext) -> None:
        ...
        记录来源任务与使用统计）。
        """
        from autobugfixer.core.models import VerificationPlan
        from autobugfixer.knowledge.skill import SkillService
